...
public class ModFoodProperties {
    ...
    public static final FoodProperties CURED_ROTTEN_FLESH = new FoodProperties.Builder().nutrition(5).saturationModifier(0.50f).effect(getAbsorptionEffect(), 1.0f).build();
}
